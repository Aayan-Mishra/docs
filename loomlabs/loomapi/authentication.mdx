...
description: "How to authenticate to Loom API using SSK/Bearer tokens."
---

# Authentication

Loom API uses SSK-style bearer tokens compatible with OpenAI SDKs. Obtain a key from your Loom Labs account dashboard and pass it in the `Authorization` header:
