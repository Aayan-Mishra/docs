...
description: "Error shapes and rate limiting for Loom API."
---

# Rate limits & Errors

Loom API returns OpenAI-like error objects, with a Loom-specific `code` and `request_id` field for tracing.
