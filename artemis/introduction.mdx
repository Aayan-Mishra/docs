---
title: "Introduction to Artemis RL Gym"
...
**A Production-Ready Distributed Reinforcement Learning Framework for Large Language Models**temis RL Gym"
description: "A production-ready distributed reinforcement learning framework for Large Language Models"
---
...
graph TB
    ...
    subgraph "Models & Environments"
        LLM[LLM Models<br/>50+ Supported]
        ENV[RL Environments<br/>Math, Code, Games]
    end
    ...
    style IE fill:#0EA5E9,stroke:#0284C7,color:#fff
    style EO fill:#8B5CF6,stroke:#7C3AED,color:#fff
    style CL fill:#F59E0B,stroke:#D97706,color:#fff
```
