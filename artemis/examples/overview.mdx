...
<Step title="Basic Training Script">
  ...
  async def basic_example():
      ...
      print("🚀 Starting Artemis RL training...")
...
async def math_reasoning_example():
    ...
    print("🧮 Starting mathematical reasoning training...")
    ...
    print("\n🎯 Training completed! Model saved to math_reasoning_agent.pt")
...
async def evaluate_math_agent():
    ...
    print("📊 Evaluating math agent on GSM8K test set...")
...
async def code_generation_example():
    ...
    print("💻 Starting code generation training...")
    ...
    for episode in range(total_episodes):
        ...
        if episode % 30 == 0:
            ...
            print(f"Tests passed: {'✅' if step_result.info.get('all_tests_passed') else '❌'}")
...
async def test_on_human_eval():
    ...
    print("🧪 Testing on HumanEval dataset...")
...
async def free_distributed_training():
    ...
    print("🆓 Setting up free distributed training...")
    ...
    print("✅ Free communication layer started")
    
    # Start monitoring system
    monitoring = MonitoringSystem(config["monitoring"])
    await monitoring.start()
    print(f"✅ Monitoring dashboard at http://localhost:{config['monitoring']['dashboard_port']}")
...
async def business_strategy_training():
    ...
    print("💼 Starting business strategy training...")
    ...
    print("💼 Business strategy training completed!")
