...
<Step title="Install Artemis RL Gym">
  ...
  ```bash
  pip install git+https://github.com/Noema-Research/ArtemisRL-Gym.git[dev]
  ```
</Step>
...
graph LR
    ...
    style TR fill:#16A34A,stroke:#15803D,color:#fff
    style SM fill:#0EA5E9,stroke:#0284C7,color:#fff
...
3. Review the [examples](/artemis/examples) for similar use cases