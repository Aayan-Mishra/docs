...
graph TD
    subgraph PRISM ["PRISM Architecture"]
        ...
        SP["Stochastic Policy<br/>π(a_t|s_t) + ε·σ_PM"]
        RV["Risk-Adjusted Value<br/>Q = E[R] - λ·Var[R]"]
    end
...
python -c "from artemis.rl_algorithms.prism import PRISM; print('✅ PRISM ready')"
```
</Step>
...
async def prism_quickstart():
    ...
    print("✅ PRISM training completed!")
...
def profile_prism_resources():
    ...
    print("🔍 PRISM Resource Usage Report:")
...
<CardGroup cols={2}>
<Card title="📚 Advanced Theory" icon="brain">
  **Deep Dive Topics:**
...
<Accordion title="🔗 Related Tutorials">
